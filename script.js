      ...
      var Game = function(config) {
              ...
              pushStyle();
                  ...
                  if(this.timer > this.TOTAL_TIME - 10 && this.timer < this.TOTAL_TIME - 5) {
                      pushStyle();
                          ...
                          textSize(40);
                          fill(255, 80);
                          text("Hurry Up Before You Run Out Of Time!", 300, 100);
                      popStyle();
                  }
          ...
          this.how = function() {
              ...
              pushStyle();
                  ...
                  textSize(13);
                  fill(255, 220);
                  text("This is a game on Halloween. If you want to know how i made this then you can watch the video on my channel. This game's basic structure was little bit inspired with google's 2018 game but only the basic structre. You can try and fail with how to play the game. GOOD LUCK :)", 40, 160, 520, 600);
              popStyle();
          ...
          this.scoreboard = function() {
              ...
              pushStyle();
                  ...
                  textAlign(CENTER);
                  textSize(18);
                  text("Updates Coming Soon :)", 300, 160);
                  textAlign(RIGHT);
                  fill(255, 220);
                  textSize(13);
                  textLeading(27);
